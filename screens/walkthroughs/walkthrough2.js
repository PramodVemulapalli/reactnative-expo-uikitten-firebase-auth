...
export class Walkthrough2 extends React.Component {
  ...
  render() {
    ...
    */
    ...
    image_quality = <Image style={{ resizeMode: 'contain', height: height_sub, width: width_sub }} source={require('../../assets/images/quality.png')}/> ;
    return (
      <View style={styles.screen}>
        {image}
        {image_quality}
        <RkText rkType='header2' style={styles.text}>Offers the best quality</RkText>
      </View>
    )
  }
}
